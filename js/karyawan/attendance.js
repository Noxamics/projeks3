...
function openAttendanceModal(employee) {
  ...
  document.getElementById("attendance_code").textContent =
  ...
  if (employee.photo && employee.photo.trim() !== "") {
    ...
    photoEl.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
      initial
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (checkInForm) {
    checkInForm.addEventListener("submit", async function (e) {
      ...
      try {
        const response = await fetch("../actions/attendance/checkin.php", {
          method: "POST",
          body: formData,
        });
  ...
  if (checkOutForm) {
    checkOutForm.addEventListener("submit", async function (e) {
      ...
      try {
        const response = await fetch("../actions/attendance/checkout.php", {
          method: "POST",
          body: formData,
        });
