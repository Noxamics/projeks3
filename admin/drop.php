    ...
    <div class="drop-container">
                ...
                while ($customer = $result_customers->fetch_assoc()) {
                    ...
                    foreach ($orders_data as $index => $order) {
                        ...
                        switch ($payment_status) {
                            case 'Lunas':
                                $paymentColor = 'color: #059669; font-weight: 600;';
                                break;
                            case 'Pending':
                                $paymentColor = 'color: #f59e0b; font-weight: 600;';
                                break;
                            default:
                                $paymentColor = 'color: #dc2626; font-weight: 600;';
                        }
                ...
                <form method="POST" action="drop_add.php" class="grid-form" id="addForm">
                    ...
                    <div id="itemsContainer" style="grid-column: 1 / -1;">
                        ...
                        <div class="item-group" data-item-index="1">
                            ...
                            <div
                                style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; margin-top: 40px;">
                                <div>
                                    <label>🏷️ Brand / Merk</label>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="items[1][est_finish_date]" class="item-est-date" readonly
                    ...
                    <div class="order-summary" style="grid-column: 1 / -1;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px;">
                            ...
                            <div>
                                <label>Tanggal Estimasi Selesai</label>
                                <input type="date" id="finalEstDate" name="est_finish_date" readonly
                                    style="background:#fff; font-weight: 600;">
                            </div>
                        </div>
                    </div>
        ...
        <div id="successModal" class="modal">
            <div class="modal-content" style="max-width: 400px; text-align: center; padding: 40px;">
                ...
                <p id="successMessage" style="font-size: 18px; font-weight: 600; color: #059669; margin-bottom: 24px;">
